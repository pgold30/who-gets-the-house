...
The author is an independent researcher in Berlin. There was no external funding. The author reports no relevant financial interests or positions and no outside rights to review the research before dissemination. The paper is not currently under review elsewhere. This version is prepared for submission to the Journal of Housing Economics; no repository DOI is claimed.

AI tools assisted with drafting, literature checking, code development and replication review. The author is responsible for the manuscript, interpretations, citations and release decisions. This statement does not certify independent human verification of unresolved instrument classifications. The research uses administrative public records rather than an experiment or survey; no ethics-board approval or exemption number is asserted.
...
\input{generated/targeted_periods}
